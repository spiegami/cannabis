  ...
  render() {
    return (
      <div className="about-container">
        ...
        <h4>Che cos'è <span className="spiegami">Spiegami</span> la liberalizzazione della Cannabis</h4>
        <p><span className="spiegami">Spiegami</span> la liberalizzazione della Cannabis è una piattaforma di analisi delle motivazioni a favore e contro la liberalizzazione della Cannabis, così come proposta dagli attuali disegni di legge in discussione in Italia.</p>
        ...
        <p><span className="spiegami">Spiegami</span> è una piattaforma per l'esplorazione e lo sviluppo di ragionamenti. Per il momento c'è la parte di esplorazione di alcuni teoremi relativi al <a href ="https://spiegami.github.io/referendum">Referendum Costituzionale</a> e questa parte relativa alla liberalizzazione della Cannabis. In prospettiva, vogliamo scegliere nuovi temi da analizzare, implementare un sistema di obiezioni e un sistema di ricerca funzionale (questo sarà un punto chiave!), rendere possibile ad un gruppo di editors di aggiungere nuovi teoremi, per poi estendere questa possibilità a chiunque. E mille altre cose per rendere l'esperienza di <span className="spiegami">Spiegami</span> accessibile e fruibile: dalla lettura ad alta voce dei ragionamenti (per chi non può leggere perché impossibilitato o perché sta guidando o cucinando) al suggerimento di ragionamenti interessanti per ogni utente, in base alle preferenze espresse.</p>
